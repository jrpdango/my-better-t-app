        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-shortpoint-text-subtle text-base leading-relaxed">
              Manage and organize your departmental sites across your
              organization
            </p>
          </div>
          <Button
        ...
        {mockSites.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-shortpoint-text-subtle mb-6 max-w-md mx-auto">
              Get started by creating your first departmental site. Each site
              can be customized with its own navigation, pages, and themes.
            </p>
